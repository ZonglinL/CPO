...
from transformers import AutoModelForDepthEstimation # depth estimation
...
def get_reward_model(task='segmentation', model_path='mmseg::upernet/upernet_r50_4xb4-160k_ade20k-512x512.py'):
    ...
    if task == 'segmentation':
        ...
        #return DPTForDepthEstimation.from_pretrained("Intel/dpt-hybrid-midas")
        folder = os.path.expanduser("~/.cache/share/depth-anything")
        try:
