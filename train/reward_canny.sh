...
export OUTPUT_DIR="work_dirs/reward_model/MultiGen20M_Canny/finetune_DINO"

## you may train controlnet++ with dino adpater by switching to reward_control.py

accelerate launch --config_file "train/config.yml" \
 --main_process_port=27443 train/reward_DINO.py \
