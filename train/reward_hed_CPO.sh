...
export CONTROLNET_DIR="reward_controlnet_download/checkpoints/hed/controlnet/"
export REWARDMODEL_DIR="https://huggingface.co/lllyasviel/Annotators/resolve/main/ControlNetHED.pth"
export OUTPUT_DIR="work_dirs/reward_model/MultiGen20M_Hed/CPO"


accelerate launch --config_file "train/config.yml" \
 --main_process_port=23153 train/reward_CPO.py \
 ...
 --conditioning_image_column="winner_hed" \
