...
export CONTROLNET_DIR="Your_fineuned_ControlNet_model"
export REWARDMODEL_DIR="mmpose::body_2d_keypoint/dekr/coco/dekr_hrnet-w32_8xb10-140e_coco-512x512.py"
export OUTPUT_DIR="work_dirs/reward_model/Captioned_COCOPose/CPO"
...
accelerate launch --config_file "train/config.yml" \
 ...
 --task_name="pose" \
 --dataset_name="ucfzl/Pose_Reward_DPO_cond" \
