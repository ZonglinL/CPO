...
from diffusers.utils import check_min_version, is_wandb_available, make_image_grid,deprecate
...
def main(args):
    ...
    print('initializing flux controlnet from FLUX.1 dev')
    ...
    # === 2. Save full weights only from global rank 0 ===
    
    save_dir = f"flux_controlnet_base"
    
    flux_controlnet.save_pretrained(save_dir) 
