...
export CONTROLNET_DIR="reward_controlnet_download/checkpoints/lineart/controlnet"
export REWARDMODEL_DIR="https://huggingface.co/spaces/awacke1/Image-to-Line-Drawings/resolve/main/model.pth"
export OUTPUT_DIR="work_dirs/reward_model/MultiGen20M_LineDrawing/CPO"


accelerate launch --config_file "train/config.yml" \
 --main_process_port=23150 train/reward_CPO.py \
 ...
 --conditioning_image_column="winner_lineart" \
