...
export CONTROLNET_DIR="ucfzl/ControlNet_Hed_CPO"
#export CONTROLNET_DIR="ucfzl/ControlNet_DINO_Hed_CPO"
...
accelerate launch --config_file "eval/config.yml" --main_process_port=19997 eval/eval.py --task_name='hed' --dataset_name='limingcv/MultiGen-20M_canny_eval' --dataset_split='validation' --condition_column='image' --prompt_column='text' --model_path $CONTROLNET_DIR --guidance_scale=${SCALE} --num_inference_steps=${NUM_STEPS}
...
rm ${DATA_DIR}/images/*/*lineart*

python eval/eval_fid.py --task_name='hed' --dataset_name='limingcv/MultiGen-20M_canny_eval' --dataset_split='validation' --condition_column='image' --prompt_column='text'  --model_path $CONTROLNET_DIR --guidance_scale=${SCALE} --num_inference_steps=${NUM_STEPS}
