...
export CONTROLNET_DIR="ucfzl/ControlNet_segmentation_ADE20K_CPO"
#export CONTROLNET_DIR="ucfzl/ControlNet_DINO_segmentation_ADE20K_CPO"
...
## If using dino adapter, switch to eval_dino.py
accelerate launch --config_file "eval/config.yml" --main_process_port=23456 eval/eval.py --task_name='seg' --dataset_name='limingcv/Captioned_ADE20K' --dataset_split='validation' --condition_column='control_seg' --prompt_column='prompt' --label_column='seg_map' --model_path=${CONTROLNET_DIR} --guidance_scale=${SCALE} --num_inference_steps=${NUM_STEPS} --ddim

python eval/eval_fid.py --task_name='seg' --dataset_name='limingcv/Captioned_ADE20K' --dataset_split='validation' --condition_column='control_seg' --label_column='seg_map' --prompt_column='prompt'  --model_path $CONTROLNET_DIR --guidance_scale=${SCALE} --num_inference_steps=${NUM_STEPS}
...
python eval/eval_clip.py --generated_image_dir=$IMAGE_DIR --dataset='limingcv/Captioned_ADE20K'